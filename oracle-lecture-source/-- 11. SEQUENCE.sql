...
-- 시퀀스명.CURRVAL  : CURRENT VALUE  - SEQ_EMPID(시퀀스명)
-- 시퀀스명.NEXTVAL  : NEXT VALUE
-- NEXTVAL을 1회 수행해야 CURRVAR를 알 수 있다.
...
SELECT SEQ_EMPID.NEXTVAL FROM DUAL; -- 시퀀스 SEQ_EMPID.NEXTVAL exceeds MAXVALUE은 사례로 될 수 없습니다
SELECT SEQ_EMPID.CURRVAL FROM DUAL; -- 310 / MAXVALUE 310이고 NOCYCLE이기때문에 다시 순환하지 않는다.
